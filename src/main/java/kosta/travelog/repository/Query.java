...
public interface Query {
    ...
    String POST_USER_IMAGE_AND_NICKNAME = "SELECT u.profile_image, u.nickname FROM Posts p inner join users u on p.user_id = u.user_id WHERE p.post_id = ?";
    ...
    String POST = "SELECT post_id, post_title, post_description, post_hashtag, post_date, post_status FROM Posts WHERE post_id = ?";
